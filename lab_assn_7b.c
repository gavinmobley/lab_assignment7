...
int main() {
    ...
    printf("\nNumber of swaps for Array 1:\n");
    for (int i = 0; i < size1; i++) {
        printf("%d: # of times %d is swapped\n", array1[i], bubbleSwaps1[array1[i]] + selectionSwaps1[array1[i]]);
    }
    
    printf("\nNumber of swaps for Array 2:\n");
    for (int i = 0; i < size2; i++) {
        printf("%d: # of times %d is swapped\n", array2[i], bubbleSwaps2[array2[i]] + selectionSwaps2[array2[i]]);
    }
